...
export default function T10EtsiOsoiteJaSijainti() {
    ...
    useEffect(() => {
        (async () => {
            ...
            const newLatitude = parseFloat(location.coords.latitude);
            const newLongitude = parseFloat(location.coords.longitude);
            setRegion(prevRegion => ({
                ...prevRegion,
                latitude: newLatitude,
                longitude: newLongitude
